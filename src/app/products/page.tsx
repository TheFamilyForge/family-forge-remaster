...
const cutouts = [
  ...
  { src: '/assets/photos/fall-pumpkin-charcuterie-board.webp', alt: 'Fall Pumpkin Charcuterie Board' },
      ...
      <section className={styles.contentSection}>
        <div className={styles.contentContainer}>
          ...
          <div className={styles.contentText}>
            ...
            <p>
              At The Family Forge, we have many different products. We specialize in paddle boards and rectangular boards with rounded edges—both feature easy-to-hang holes or slits. While those are our standard, we also do fully custom surfaces.
            </p>
            <p>
              We can engrave any wooden cutting board or ornamental piece within reason. By default we provide the board; on special request you may supply your own.
            </p>
            <p>
              Our square bamboo cutting board — pictured here with its handle — starts at <b>$20</b>. Custom engraving is an additional <b>$5</b>.
            </p>
          </div>
